...
Ext.Loader.setPath('Ext.ux', 'extjs-docs-5.0.0/extjs-build/examples/ux');
Ext.require([
    'Ext.grid.*',
    'Ext.data.*',
    'Ext.form.*',
...
Ext.onReady(function() {
    ...
    var opciones = Ext.create('Ext.button.Button',{
        ...
        menu : [
            {text : 'Asignar Plazas', iconCls : 'icon-asignar-plazas', tooltip : 'Editar Posición de Parqueaderos', handler : function(){windowAsigPlazas();}}
        ]
    });
