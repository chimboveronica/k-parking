    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            echo "
                ...
                var id_parking = ".$_SESSION["ID_PARKING"].";
                ";
            ?>
        </script>        
        ...
        <script type="text/javascript" src="js/roles/controlador.js"></script>
        ...
        <script type="text/javascript" src="js/gui/controlador/ventanaAsignarPlazas.js"></script>
